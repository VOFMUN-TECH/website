...
export const schoolDelegations = pgTable('school_delegations', {
  ...
  wantsHotels: boolean('wants_hotels').notNull().default(false),
  wantsFlights: boolean('wants_flights').notNull().default(false),
  wantsAirportTransfers: boolean('wants_airport_transfers').notNull().default(false),
  wantsConferenceTransport: boolean('wants_conference_transport').notNull().default(false),
